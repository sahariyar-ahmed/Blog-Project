...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3">Create Update</h4>
                ...
                <form role="form" action="{{route('blog.update',$blog->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea id="shortNote" type="text" class="form-control @error('short_description') is-invalid @enderror" id="inputEmail3"  name="short_description">{{$blog->short_description}}</textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea id="longNote" type="text" class="form-control @error('description') is-invalid @enderror" id="inputEmail3"  name="description">{{$blog->description}}</textarea>
                        </div>
                        @error('description')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-9 d-flex justify-content-center">
                            <img id="hulk" src="{{asset('uploads/blog')}}/{{$blog->thumbnail}}" style="width:30%; height=200px; object-fit:contain ">
                        </div>
                    </div>
                    <div class="row mb-2">
